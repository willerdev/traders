/**
 * One-off: move full wallet balance → Smart Invest for nenshiboy@gmail.com (admin transfer, no fee).
 * Usage: cd backend && npx tsx scripts/transfer-nenshiboy-wallet-to-invest.ts
 */
